 ...
 *      E.g., for number 2865432 with prefix '28654' and limit 6 for position 2 (valStr[1])
 *          we have 7*7*7*7 combinations of integers,
 *          that can be represented as: min(valStr[1], radix) * radix * radix * radix
 ...
 *      E.g., for number 234567 with prefix '2345' and limit 6 for position 1 (valStr[0])
