/**
 * Approach: Hashing with
 * - Greedy approach forms a group for each color
 * - Frequency Array counts the occurrences of each reported group size
 ...
 * Space: O(1)
 */
function numRabbits2(answers: number[]): number {
